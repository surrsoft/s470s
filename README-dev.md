...
Форма F1F (скрыта по умолчанию, открывается при добавлении/редактировании)
  ...
  - F25F Выпадающий список: родительская заметка (parent); по умолчанию — текущий уровень навигации
  - F26F Блок симлинков: список дополнительных родителей (parentIdsOther); кнопка «+» открывает выпадающий список для добавления очередного симлинка
  - Чекбокс: Fast copy — если включён, клик по заметке сразу копирует текст (без захода внутрь)
  - Кнопки: Save · Cancel
