...
Форма F1F (скрыта по умолчанию, открывается при добавлении/редактировании)
  ...
  - Выпадающий список: родительская заметка (parent); по умолчанию — текущий уровень навигации
  - Блок симлинков: список дополнительных родителей (parentIdsOther); кнопка «+» открывает выпадающий список для добавления очередного симлинка
